...
import { View, Text, StyleSheet, SafeAreaView, TouchableOpacity, ScrollView, Switch, StatusBar as RNStatusBar, Platform, Modal } from 'react-native';
import { useRouter } from 'expo-router';
import { ArrowLeft, Moon, Sun, Globe, Trash2, Info, Smartphone, AlertTriangle, CheckCircle2 } from 'lucide-react-native';
          ...
          <View style={[styles.sectionCard, currentTheme.cardBg]}>
            ...
            <TouchableOpacity style={styles.settingRow} onPress={() => changeLanguage(language === 'en' ? 'ml' : 'en')} activeOpacity={0.7}>
              ...
              <View style={styles.langBadge}>
                <Text style={styles.langBadgeText}>{language === 'en' ? 'English' : 'മലയാളം'}</Text>
              </View>
            </TouchableOpacity>
          </View>
...
const lightStyles = StyleSheet.create({ containerBg: { backgroundColor: '#f8fafc' }, cardBg: { backgroundColor: '#ffffff', borderColor: '#e2e8f0' }, textMain: { color: '#1e293b' }, textMuted: { color: '#64748b' }, borderLine: { borderBottomColor: '#f1f5f9' } });
const darkStyles = StyleSheet.create({ containerBg: { backgroundColor: '#0f172a' }, cardBg: { backgroundColor: '#1e293b', borderColor: '#334155', borderWidth: 1 }, textMain: { color: '#f1f5f9' }, textMuted: { color: '#94a3b8' }, borderLine: { borderBottomColor: '#334155' } });
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 13, fontWeight: 'bold', marginBottom: 10, marginTop: 10, letterSpacing: 0.5, includeFontPadding: false },
  ...
  langBadge: { backgroundColor: '#eff6ff', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20 },
  langBadgeText: { color: '#2563eb', fontWeight: 'bold', fontSize: 13, includeFontPadding: false },
